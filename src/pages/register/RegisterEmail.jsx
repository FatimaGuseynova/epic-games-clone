...
function RegisterEmail() {
    return (
        <div className='bg-[#101014] h-screen flex p-10 min-[480px]:justify-center items-center '>
            <div className='min-[480px]:bg-[#18181C] overflow-hidden min-[480px]:w-[550px] max-w-[96%] p-11 flex flex-col  min-[480px]:rounded-[14px] min-[480px]:border-1 min-[480px]:border-[#303033] '>
                ...
                <div>
                    <input type="text" required className={`hover:border-[#9b9ba2] duration-150 py-3 border-1 w-[100%] px-5 rounded-2xl border-[#5a5a5f]`} />
                </div>
                <div className=''>
