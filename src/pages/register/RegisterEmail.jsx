...
function RegisterEmail() {
    return (
        <div className='bg-[#101014] h-screen flex p-10 justify-center items-center '>
            <div className='min-[480px]:bg-[#18181C] overflow-hidden min-[480px]:w-[550px] max-w-[85%] p-11 flex flex-col  min-[480px]:rounded-[14px] min-[480px]:border-1 min-[480px]:border-[#303033] '>
                <div>
                ...
                <div>
                    <input type="text" required className={` py-3 border-1 w-[100%] px-5 rounded-2xl border-[#5a5a5f]`} />
                </div>
                <div className=''>
                    <Link to="" className='block text-center w-full my-6 mb-3 hover: rounded-[8px] duration-150 hover:bg-[#65ccfb] bg-[#26BBFF] py-2 text-black'>Continue</Link>
                </div>
