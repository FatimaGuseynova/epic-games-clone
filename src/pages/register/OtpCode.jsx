...
function OtpCode() {
    ...
    const handleResend = async () => {
        try {
            ...
            console.log("OTP отправлен повторно:", response);
            ...
            <div className="min-[480px]:bg-[#18181C] overflow-hidden min-[480px]:w-[550px] min-[480px]:max-w-[96%] min-[480px]:p-11 max-[480px]:py-11 flex flex-col min-[480px]:rounded-[14px] min-[480px]:border min-[480px]:border-[#303033]">
                    ...
                    <div className="flex gap-4">
                        {otp.map((digit, index) => (
                            <input
                                ...
                                disabled={loading}
                                className={`${red ? "border-[#FF6173]" : "border-[#5a5a5f]"} hover:border-[#9b9ba2] caret-white w-[20%] duration-150 py-4 border px-5 rounded-[7px] text-white text-center outline-none focus:border-white disabled:opacity-50`}
                            />
                        ))}
                    </div>
                ...
                >
                    <button
                        ...
                        disabled={loading}
                        className="text-[#2290C3] underline disabled:opacity-50"
                    >
                        Resend Email
                    </button>
                </div>
