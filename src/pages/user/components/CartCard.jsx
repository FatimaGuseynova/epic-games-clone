...
function CartCard({ product, cartItem, onRemove, onAddToWishlist }) {
    if (!product) {
        return null
    }

    const isFree = product.isFree || Number(product.price) === 0
    ...
    return (
        <div className="bg-[#202023] ml-10 min-[1020px]:w-[55vw] w-[90vw] rounded-[16px] p-4 min-[768px]:p-6">
            <div className="flex  gap-6">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex justify-end items-center gap-3 mt-5 max-[767px]:hidden">
                        ...
                        {!isFree && (
                            <button className="w-[50px] h-[50px] border border-[#66666a] rounded-[10px] flex items-center justify-center text-white">
                                <GrGift size={21} />
                            </button>
                        )}
                    ...
                    <div className="hidden max-[767px]:flex flex-col mt-4">
                        ...
                        <div className="flex items-center gap-2 mt-3">
                            {!isFree && (
                                <button className="w-[32px] h-[32px] border border-[#66666a] rounded-[5px] flex items-center justify-center text-white shrink-0">
                                    <GrGift size={14} />
                                </button>
                            )}
