...
function AddFunds({ setOpen, product, onBalanceUpdate }) {
    ...
    return (
        <div className='fixed inset-0 z-[999] bg-black/70 flex items-center justify-center p-4 overflow-hidden'>

            <div className='bg-[#181819] w-full max-w-[1100px] max-h-[90vh] rounded-xl overflow-hidden flex flex-col min-[760px]:flex-row'>

                <div className='min-[760px]:w-[25%] min-[760px]:border-r border-[#2a2a2e] p-6 shrink-0'>
                ...
                <div className='min-[760px]:w-[75%] p-8 relative flex flex-col items-center overflow-y-auto min-h-0'>
                    ...
                    <p className='text-[#3ddc97] text-[36px] font-light mb-4 min-h-[54px] flex items-center justify-center'>
                        {balanceLoading ? (
                            <span className='text-[22px] text-[#a0a0a3]'>
                                Loading...
                            </span>
                        ) : (
                            `$${balance.toFixed(2)}`
    ...
    <div className='border border-[#77777b] rounded-xl overflow-hidden'>
        ...
        <div className='h-[60px] flex items-center justify-between px-6 border-b border-[#77777b]'>
            <input
                ...
                className='w-full bg-transparent outline-none text-[#b9bac4] text-[18px] placeholder:text-[#b9bac4]'
            />
        ...
        <div className='flex h-[60px]'>
            ...
            <div className='w-1/2 flex items-center justify-between px-6'>
                ...
                <FiHelpCircle
                    size={20}
                    className='text-[#a0a0a3] shrink-0 ml-2'
                />
            </div>
        </div>
    ...
    <input
        ...
        className='w-full h-[60px] border border-[#77777b] rounded-xl flex items-center px-6 bg-transparent outline-none text-[#b9bac4] text-[18px] placeholder:text-[#b9bac4]'
    />
</div>
