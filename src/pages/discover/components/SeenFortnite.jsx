            ...
            <div className="min-[1100px]:w-[77%] w-[93%] mx-auto">
                <div className="flex items-center max-[770px]:flex-col justify-between gap-11">
                    <div
                        ...
                        style={{
                            backgroundImage:
                                "url('https://cdn2.unrealengine.com/egs-fortniteoverrideexperiencepage-brandedlist-1200x1200-v1-r3-1200x1200-8180053db5d3.png?resize=1&w=360&h=480&quality=medium')"
                        }}
                    >
                        <Link
                            to="/"
