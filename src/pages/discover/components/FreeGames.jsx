                ...
                <div className="min-[1100px]:w-[77%] w-[93%] mx-auto">
                    ...
                    <div className='flex flex-wrap  gap-5'>
                        {products.map((item, index) => (
                            <Link to="/detail" state={{ product: item }} className=''>
                                <div className='rounded-[6px] shrink-0 flex items-end text-center w-full h-[200px] max-[790px]:h-[300px] bg-center bg-cover flex-wrap aspect-[20/9] ' style={{ backgroundImage: `url(${item.productLogo.url}` }} key={index}>
