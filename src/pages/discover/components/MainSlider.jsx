    ...
    <div>
      <div className=' pt-10 max-[768px]:hidden'>
        <div className='flex items-center justify-center gap-5'>
            ...
            <div className=' '>
              ...
              <div className='flex flex-col p-5 min-[890px]:pb-20 h-full justify-end absolute z-10  w-[50%]'>
                ...
                <div className='p-4 pt-6 relative'>
                  ...
                  <h6 className='text-[15px]'>Save big on must-play games and discover
                    new adventures.</h6>
                </div>
          ...
          <div>
            <ul>
              <li className='hover:bg-[#4c4c4c87] duration-150 p-4 pl-2 py-2 rounded-[10px] flex items-center gap-3'>
