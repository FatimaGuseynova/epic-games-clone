...
function SingIn() {
  ...
  const created = localStorage.getItem("accountCreated") === "true";

  const [accountCreated, setAccountCreated] = useState(created);
  ...
  const {
    ...
    initialValues: {
      email: created ? localStorage.getItem("email") || "" : ""
    },
          ...
          <div className='flex items-center justify-between gap-4'>
            <div>
              ...
              <p className='text-[#A7A7A9] text-[13px] mt-1'>
                You can now sign in to your Epic Games account.
              </p>
            </div>
      ...
      <div className='min-[480px]:bg-[#18181C] overflow-hidden min-[480px]:w-[550px] min-[480px]:max-w-[96%] min-[480px]:p-11 max-[480px]:py-11 flex flex-col min-[480px]:rounded-[14px] min-[480px]:border-1 min-[480px]:border-[#303033]'>
        <div className='animate-slide-in-right'>
          <div className='flex flex-col items-center justify-center'>
            <Logo />
            <h2 className='text-white font-semibold py-4 text-[23px]'>
          ...
          <form onSubmit={handleSubmit} className='w-full'>
            <input
              ...
              required
              className={`${errors.email && "border-[#FF6173]"} hover:border-[#9b9ba2] duration-150 py-3 border-1 w-[100%] px-5 rounded-2xl border-[#5a5a5f]`}
            />
            ...
            <button
              type='submit'
              className='w-full my-6 rounded-[8px] bg-[#26BBFF] block text-center py-2 text-black'
            >
              Continue
            </button>
          </form>
          ...
          <div>
            <h6 className='text-center text-[15px] text-[#A7A7A9]'>
              New here?{" "}
              <Link
                to="/signin/register"
                className="text-[#26B7F9] underline"
              >
                Create an account
              </Link>
            </h6>
          ...
          <div className='text-center'>
            <h5 className='font-semibold text-[18px]'>
              Only played on console?
            </h5>
            <p className='text-[14px] text-[#A7A7A9]'>
              Sign in to access your progress and purchases
            </p>
          </div>
          ...
          <ul className='flex items-center w-full gap-3 justify-between py-4'>
            ...
            <li className='bg-[#242428] flex flex-col justify-center items-center duration-300 p-3 px-0 w-[100%] rounded-[15px] hover:bg-[#555560]'>
              <img className='w-12 pb-2' src={xbox} alt="xbox" />
              <p className='text-[11px] font-semibold'>Xbox</p>
              <p className='text-[11px] font-semibold'>Network</p>
            </li>
          ...
          <ul className='flex items-center w-full gap-3 justify-between py-4'>
            ...
            <li className='bg-[#242428] flex flex-col justify-center items-center duration-300 p-3 px-0 w-[100%] rounded-[15px] hover:bg-[#555560]'>
              ...
              <p className='text-[11px] font-semibold'>Lego Account</p>
            </li>
