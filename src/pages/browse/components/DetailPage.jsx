        ...
        <div className='min-[760px]:grid-cols-[2fr_1fr] gap-5 grid grid-cols-1 '>
          ...
          <div className='min-[760px]:order-2  min-w-0 '>
            ...
            <div className='flex gap-2 items-center justify-center'>
              ...
              <div className='bg-[#343437] rounded-[5px] my-5 px-2 py-0.5'>
                ...
                {product?.types?.[0]?.name === "Game"
                  ? "Base Game"
                  : product?.types?.[0]?.name || ""}

              </div>

              {product?.events?.[0]?.name === "First Run" &&
                <div className='bg-[#343437] rounded-[5px] my-5 px-2 py-0.5'>
            ...
            {product?.events?.[0]?.name === "EA Classic Games on Epic" && (
              ...
              <p className=' text-[13px] flex items-center gap-2'>
                <img src={subsea} alt="ea play" className='w-4 rounded-full' />
                <span>Save 10% with <span className='underline'>EA Play</span></span>
              </p>
            ...
            <div>
              ...
              <div className='flex items-center gap-2'>
                ...
                <button
                  ...
                  className='w-full my-6 mt-2 rounded-[8px] bg-[#26BBFF] block text-center py-3 mb-3 text-black duration-150 hover:bg-[#6dd1ff]'
                >
                  Buy Now
                </button>
              ...
              <button
                onClick={handleAuthAction}
                className='w-full flex items-center justify-center rounded-[8px] bg-[#343437] block text-center gap-2 py-3 text-white duration-150 hover:bg-[#646469]'
              >
                <GrGift /> Gift
              </button>
            ...
            <div>
              ...
              <ul>
                ...
                <li className='border-b-1 border-[#222226] text-[16px] min-[760px]:text-[13px] pb-2 text-[#adaba7] flex justify-between items-center mb-2'>
                  Epic Rewards
                ...
                <li className='border-b-1 border-[#222226] text-[16px] min-[760px]:text-[13px] pb-2 flex text-[#adaba7] justify-between items-center mb-2'>
                  Refund Type
                ...
                <li className='border-b-1 border-[#222226] text-[16px] min-[760px]:text-[13px] pb-2 flex text-[#adaba7] justify-between items-center mb-2'>
                  Release Date
                  <span className='flex items-center gap-1 text-white'>
                    {product?.createdAt?.slice(5, 7)}/{product?.createdAt?.slice(8, 10)}/{product?.createdAt?.slice(2, 4)}
                  </span>
                </li>
            ...
            <div className='flex w-full items-center gap-2'>
              ...
              <button className='flex w-full justify-center items-center gap-1 bg-[#343437] rounded-[8px] p-3 duration-150 hover:bg-[#646469] font-semibold'>
          ...
          <div className='min-[760px]:order-1  min-w-0'>
            ...
            {product?.events?.[0]?.name === "EA Classic Games on Epic" && (
              ...
              <div className='flex items-start gap-18 p-5 rounded-[7px] bg-[linear-gradient(135deg,#4E1C2E_0%,#341837_50%,#131242_100%)]'>
                ...
                <div>
                  ...
                  <p className='text-[#a3a4a6] pb-2'>
                    Get unlimited access to a collection of EA's top titles, trials of select new games, in-game member rewards, and 10% off EA digital purchases.
                  </p>

                  <button className='border-1 rounded-[6px] border-[#a3a4a6] px-1.5 py-1 text-[14px]'>
                    Explore
                  </button>
            ...
            <div>
              ...
              <p className='text-[13px] border-t-1 border-[#26262A] py-5 mt-5'>
