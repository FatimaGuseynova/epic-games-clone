    ...
    return (
        <div className='w-[89%] mx-auto'>
                ...
                <div className={`w-full flex justify-between`}>
                    <div className='flex gap-3'>
                        <div className='relative'>
                            <div
                                className='flex gap-1 flex-nowrap whitespace-nowrap items-center text-[15px] cursor-pointer'
                            ...
                            <ul
                                className={`absolute left-0 top-full min-w-[150px] mt-1 z-10 ${open ? "block" : "hidden"} pt-3 text-[15px] bg-[#303034] p-1 rounded-[10px]`}
                            >
                                {sortOptions.map((option, index) => (
                                    <li
                                        ...
                                        className={`duration-150 ${selected + 1 === option.id
                                            ? "bg-[#696971] rounded-[6px]"
                                            : "hover:bg-[#696971] rounded-[6px]"
                                            } ${open ? "block" : "hidden"} p-2 py-1.5`}
                                        key={index}
                                    >
                                        {option.name}
                                    </li>
                        ...
                        <div className='flex flex-wrap w-full gap-2'>
                            {selectedNames.map((item) => (
                                ...
                                >
                                    ...
                                    <IoMdClose
                                        onClick={() =>
                                            removeFilter(item.paramName, item.id)
                                        }
                    ...
                    <div className='min-[770px]:hidden block'>
                        <Link
                            ...
                            className='flex flex-nowrap whitespace-nowrap hover:bg-[#696971] duration-150 bg-[#4f4f55] rounded-[10px] py-1 px-2 gap-3 items-center'
                        >
                            <span>
            ...
            <div className='flex items-start justify-start'>
                ...
                <div className='max-[1024px]:hidden ml-10 flex-nowrap whitespace-nowrap block'></div>
